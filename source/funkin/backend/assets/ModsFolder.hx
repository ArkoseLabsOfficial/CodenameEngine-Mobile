...
class ModsFolder {
	 ...
	 */
	public static var modsPath:String = #if mobile MobileUtil.getModDir() + #else Sys.getCwd() + #end "mods/";
	/**
	 * Path to the `addons` folder.
	 */
	public static var addonsPath:String = #if mobile MobileUtil.getModDir() + #else Sys.getCwd() + #end "addons/";
